<template>
  <div class="page row" id="about">
    ...
    >
      ...
      <h6>
        WHO the visualization is for: Anyone with an interest in the overall topic of happiness and factors that might have an influence on it. It could be specifically interesting to people from Europe or residing in Europe since the survey responses are limited to participants from Europe.
